...
export const mockNotifications: NotificationDto[] = [
  {
    notificationId: 101,
    title: "Critical Inflow Alarm at High Dam",
    body: "Lake elevation reached 178.5m. Automated gate alert triggered.",
    channel: "IN_APP",
    isRead: false,
  ...
  {
    notificationId: 102,
    title: "AI Maintenance Alert (Ultrasonic Sensor)",
    body: "Station RTU-2092 ultrasonic transducer head offset anomaly detected.",
    channel: "IN_APP",
    isRead: false,
  ...
  },
  {
    ...
    body: "All 410 station hydrological feeds synchronized successfully.",
    channel: "IN_APP",
    isRead: true,
    createdAtUtc: new Date(Date.now() - 120 * 60000).toISOString(),
    readAtUtc: new Date(Date.now() - 60 * 60000).toISOString(),
  },
  {
    notificationId: 104,
    title: "New Official Report Available",
    body: "Water Quality & Salinity Compliance at Coastal Outlets is ready for download.",
    channel: "IN_APP",
    isRead: true,
    createdAtUtc: new Date(Date.now() - 240 * 60000).toISOString(),
    readAtUtc: new Date(Date.now() - 180 * 60000).toISOString(),
  },
]
...
export const notificationsApi = {
  listNotifications: async (params?: {
    ...
    try {
      const res = await apiClient.get<PagedResult<NotificationDto>>(

  ...
  return (
    <Card className="border border-slate-200 hover:border-purple-300 transition-all shadow-xs bg-white text-slate-900">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Parameter: <span className="font-semibold text-slate-700">{anomaly.parameter}</span>
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3 mt-3.5 p-3 rounded-xl bg-slate-50 text-xs border border-slate-200">
        <div>
          <span className="text-[10px] text-slate-400 font-bold block uppercase">Expected Baseline</span>
          <span className="font-semibold text-slate-700 text-sm">
            {anomaly.expectedValue} {anomaly.unit}
          </span>
        </div>
        <div>
          <span className="text-[10px] text-slate-400 font-bold block uppercase">Detected Deviation</span>
      ...
      <div className="mt-3 flex items-center justify-between text-xs pt-2.5 border-t border-slate-100">
        <span className="text-slate-400 font-medium">Neural Detection Confidence</span>

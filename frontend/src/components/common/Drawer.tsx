...
export const Drawer: React.FC<DrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex">
      ...
      <div
        className={`relative ml-auto w-full ${width} bg-white shadow-2xl z-10 flex flex-col h-full border-l border-slate-200 animate-in slide-in-from-right duration-200 text-slate-900`}
      >
        {/* Header */}

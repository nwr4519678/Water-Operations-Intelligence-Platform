...
export const Header: React.FC = () => {
  ...
  const getPageInfo = () => {
    ...
    if (path === '/') return { title: 'Overview', subtitle: 'Real-time national water network telemetry across 410 monitoring nodes in Egypt' };
    if (path === '/map') return { title: 'Map & Stations', subtitle: '410 interactive monitoring stations (Leaflet + MarkerCluster)' };
  ...
  return (
    <header className="topbar">
      <button className="menu" type="button">☰</button>

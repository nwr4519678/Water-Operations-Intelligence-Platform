    ...
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 bg-white p-2.5 rounded-xl border border-slate-200 shadow-xs text-slate-900">
      ...
      <div className="relative flex-1">
        ...
        <input
          ...
          placeholder={isAr ? 'ابحث عن محطة بالعربية أو الإنجليزية...' : 'Search by Station Code, English/Arabic name, or sector...'}
      ...
      >
        <option value="ALL">{isAr ? 'جميع المناطق الهيدرولوجية' : 'All Hydrological Regions'}</option>
        {regions.map((r) => (

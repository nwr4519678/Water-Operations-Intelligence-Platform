...
import { X, ExternalLink, Activity, Radio, Droplets, Gauge, Battery, Wifi, ShieldCheck, MapPin } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-5 text-slate-900">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            <span className="text-xs text-slate-500">{station.connectionStatus}</span>
          </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-xl p-3.5 border border-slate-200/80 space-y-2 text-xs">
          ...
          <div className="flex justify-between items-center text-slate-600 font-mono text-[11px] pt-1.5 border-t border-slate-200/60">
            ...
            <span>{station.latitude.toFixed(6)}° N, {station.longitude.toFixed(6)}° E</span>
          </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-xl p-3.5 border border-slate-200/80 space-y-2 text-xs">
          ...
          <div className="flex justify-between items-center text-slate-600">
            ...
            <span className="font-medium text-slate-800">
              {station.type === 'main' ? 'Satellite Uplink (Primary)' : 'GSM / GPRS Telemetry'}
            </span>
          </div>
          <div className="flex justify-between items-center text-slate-600">
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50">
        ...
        >
          <span>{isAr ? 'فتح التحليلات والرسوم البيانية الكاملة' : 'Open Full Telemetry Analytics'}</span>

...
const regions: RegionConfig[] = [
  {
    ...
    spreadLat: 0.8,
    spreadLng: 1.5,
    zoneAr: "إقليم شبكات ري ومصارف الدلتا",
    zoneEn: "Nile Delta Irrigation & Drainage",
  },
  {
    count: 60,
    centerLat: 29.3,
    ...
    spreadLat: 0.3,
    spreadLng: 0.4,
    zoneAr: "نطاق إدارة ري الفيوم وبحر يوسف الحرج",
    zoneEn: "Fayoum & Bahr Youssef Basin",
  },
  {
    count: 80,
    centerLat: 26.5,
    ...
    spreadLat: 2.4,
    spreadLng: 0.8,
    zoneAr: "قطاع وادي النيل ومناسي الصعيد",
    zoneEn: "Upper Egypt & Nile Valley Reach",
  },
  {
    count: 30,
    centerLat: 24.5,
    ...
    spreadLat: 1.0,
    spreadLng: 0.5,
    zoneAr: "توزيعات ري خزان أسوان وكوم أمبو",
    zoneEn: "Aswan Reservoir & Kom Ombo",
  },
  {
    count: 25,
    centerLat: 25.0,
    ...
    spreadLng: 1.8,
    zoneAr: "الخزان الجوفي بالوادي الجديد والواحات",
    zoneEn: "New Valley & Oases Deep Aquifers",
  },
  {
    count: 25,
    centerLat: 22.6,
    ...
    spreadLat: 0.5,
    spreadLng: 0.8,
    zoneAr: "محور توشكى والزراعات الاستثمارية لجنوب الوادي",
    zoneEn: "Toshka Axis & South Valley Reclamation",
  },
]
...
function generateFieldStations(): Station[] {
  ...
  for (const reg of regions) {
    for (let i = 0; i < reg.count; i++) {
      const lat = Number(
        (reg.centerLat + (prng() - 0.5) * reg.spreadLat).toFixed(4),
      )
      const lng = Number(
        (reg.centerLng + (prng() - 0.5) * reg.spreadLng).toFixed(4),
      )
...
export const allZonesList: ZoneItem[] = [
  ...
  {
    id: "delta",
    nameAr: "إقليم شبكات ري ومصارف الدلتا",
    nameEn: "Delta Irrigation & Drainage",
  },
  {
    id: "fayoum",
    nameAr: "نطاق إدارة ري الفيوم وبحر يوسف الحرج",
    nameEn: "Fayoum & Bahr Youssef Basin",
  },
  {
    id: "upper_egypt",
    nameAr: "قطاع وادي النيل ومناسي الصعيد",
    nameEn: "Upper Egypt & Nile Valley Reach",
  },
  {
    id: "aswan",
    nameAr: "أسوان وجنوب الوادي / خزان أسوان",
    nameEn: "Aswan & South Valley",
  },
  {
    id: "new_valley",
    nameAr: "الخزان الجوفي بالوادي الجديد والواحات",
    nameEn: "New Valley & Oases Deep Aquifers",
  },
  {
    id: "toshka",
    nameAr: "محور توشكى والزراعات الاستثمارية لجنوب الوادي",
    nameEn: "Toshka Axis & South Valley",
  },
  {
    id: "cairo",
    nameAr: "القاهرة الكبرى (المقر القومي)",
    nameEn: "Greater Cairo (HQ)",
  },
  {
    id: "siwa",
    nameAr: "مطروح والواحات الغربية",
    nameEn: "Matrouh & Western Oases",
  },
  {
    id: "north_coast",
    nameAr: "شمال الدلتا والبحيرات (المنزلة / البرلس)",
    nameEn: "North Delta Lagoons (Manzala / Burullus)",
  },
  {
    id: "natrun",
    nameAr: "البحيرة ووادي النطرون",
    nameEn: "Beheira & Wadi El-Natrun",
  },
]

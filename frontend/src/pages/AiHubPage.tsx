...
export const AiHubPage: React.FC = () => {
  ...
  const anomalies =
    anomaliesData?.items.map((i) => i.payload as AiAnomalyItem) || []
  const maintenancePayload =
    maintenanceData?.payload as AiMaintenancePayload | undefined
    ...
    <section className="dashboard">
      <div className="panel" style={{ padding: 0, overflow: "hidden" }}>
        ...
        <div style={{ padding: 20 }}>
          ...
          {activeTab === "focus" && <RiskMatrixGrid />}
            ...
            <div style={{ display: "grid", gap: 14 }}>
              ...
              <div className="panel" style={{ padding: 16 }}>
                ...
                <p style={{ fontSize: 11, color: "#475569", lineHeight: 1.6 }}>
                  {(stationInsightData?.payload as any)?.healthSummary ||
                    "Telemetry stream is nominal and in compliance with hydrological balance models."}
                </p>
              </div>
            </div>
          )}

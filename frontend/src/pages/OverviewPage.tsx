    ...
    <section className="dashboard">
      ...
      <div className="metrics">
        ...
        <article className="metric-card green">
          ...
          <div>
            <p>Avg Water Level</p>
            <strong>2.64<small style={{ fontSize: 13, color: 'inherit' }}> m</small></strong>
        ...
        <article className="metric-card violet">
          ...
          <div>
            <p>Total Discharge</p>
            <strong>1,840<small style={{ fontSize: 13, color: 'inherit' }}> m³/s</small></strong>
        ...
        <article className="metric-card amber">
          ...
          <div>
            ...
            <strong>4.2<small style={{ fontSize: 13, color: 'inherit' }}> bar</small></strong>
        ...
        <article className="metric-card teal">
          ...
          <div>
            ...
            <strong>94<small style={{ fontSize: 13, color: 'inherit' }}>%</small></strong>
        ...
        <article className="metric-card red">
          ...
          <div>
            ...
            <strong>38<small style={{ fontSize: 13, color: 'inherit' }}>%</small></strong>
          ...
          <div className="panel-heading" style={{ marginBottom: 8 }}>
            <div>
              ...
              <p style={{ fontSize: 11, color: '#64748b', marginTop: 2 }}>
                410 monitoring nodes across Egypt (HQ, 9 Masters, 400 Field RTUs)
              </p>
            </div>
            <button
          ...
          <section className="panel risk-panel">
            ...
            <div className="risk-content">
              ...
              <div className="risk-list">
                ...
                <p><span>▲</span> Surge probability <b>12%</b></p>
                <p><span>●</span> Pressure stress <b>24%</b></p>
                <p><span>▲</span> Turbidity drift <b>8%</b></p>
              </div>
            </div>
          </section>
        </div>
      ...
      <div className="lower-grid">
        ...
        <section className="panel chart-panel">
          ...
          <div className="chart-labels">
            <span>182m</span><span>178m</span><span>174m</span><span>170m</span><span>166m</span>
          </div>
          ...
          <div className="chart-legend">
            <span className="line blue" />Actual Level
            <span className="line violet dashed" />AI Forecast
          </div>
        </section>
        ...
        <section className="panel chart-panel">
          ...
          <div className="chart-legend">
            <span className="line green" />Discharge (m³/s)
          </div>
        </section>
      </div>
      ...
      <footer className="dashboard-footer">
        <div className="notification-card">
          ...
          <div>
            ...
            <p>Live dual satellite & GSM telemetry active for all 410 monitoring nodes across Egypt</p>
          </div>
          <time>Real-time</time>
          <div className="live"><i className="dot good" />Last sync: Live</div>
          <b>⌁ Operational</b>
        </div>

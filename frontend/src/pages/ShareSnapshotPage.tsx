    ...
    return (
      <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4">
        <Card className="max-w-md w-full text-center p-8 bg-white border-slate-200 shadow-lg">
          ...
          <h2 className="text-base font-bold text-slate-900">Snapshot Expired</h2>
          <p className="text-xs text-slate-500 mt-1 mb-5">
            This shared operational snapshot has expired or the token is invalid.
          </p>
          <Link
            to="/login"
      ...
      <div className="w-full max-w-xl space-y-4">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-200">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-sm font-bold text-slate-900">Public Telemetry Snapshot</h1>
              <p className="text-[10px] text-slate-400">National Water Operations Platform</p>
            </div>
          </div>
        ...
        <Card className="bg-white border-slate-200 p-6 space-y-4 shadow-lg">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
              <span className="text-[10px] text-slate-400 block uppercase font-bold">Water Level</span>
              <span className="text-base font-bold text-blue-600 mt-0.5 block">{parsed.waterLevel || '178.5 m'}</span>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
              <span className="text-[10px] text-slate-400 block uppercase font-bold">Flow Rate</span>
              <span className="text-base font-bold text-emerald-600 mt-0.5 block">{parsed.flowRate || '2100 m³/s'}</span>
            </div>
            <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
              <span className="text-[10px] text-slate-400 block uppercase font-bold">Pressure</span>
              <span className="text-base font-bold text-purple-600 mt-0.5 block">{parsed.pressure || '8.4 bar'}</span>
            </div>
          </div>
